# 
# Solution to Advent of Code 2021: day 00 part 2
# Copyright (c) Andrea Fresco. All rights reserved.
# 
# https://adventofcode.com/
# 

def count_increment_3_sliding(file = r'./input.txt'):
    ...
    with open(file, 'r') as f:
        ...
        x_n_3 = int(f.readline().rstrip("\n")) # x[n-3]: read the first value in the array
        x_n_2 = int(f.readline().rstrip("\n")) # x[n-2]: read the second value in the array
        x_n_1 = int(f.readline().rstrip("\n")) # x[n-1]: read the third value in the array 
        ...
        for line in f:
            ...
            if str_num: # avoid empty string (e.g. '')
                ...
                sliding_sum_n_1 = x_n_3 + x_n_2 + x_n_1 # SUM[n-1] = x[n-1] + x[n-2] + x[n-3]
...
if __name__ == "__main__":
    ...
    print(count_increment_3_sliding())